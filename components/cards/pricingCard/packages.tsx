interface price_package {
  name: string;
}

const package_basic: price_package[] = [
  {
    name: "First 4 Modules (2 modules are currently completed)",
  },
  {
...
const package_complete: price_package[] = [
  ...
  {
    name: "Entire Course (2 modules are currently completed)",
  },
  {
    name: "Download all videos for offline access",
  },
...
const package_exclusive: price_package[] = [
  {
    name: "Everything in the complete package",
  },
  {
...
export { package_basic, package_complete, package_exclusive };
