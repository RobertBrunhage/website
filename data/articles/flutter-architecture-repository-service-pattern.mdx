...
class AnimalService {
  ...
  Future<List<Animal>> getAllAnimals() async {
    try {
      ...
      // Example will just rethrow the same exception. I personally love using https://pub.dev/packages/multiple_result and return a custom failure.
      throw e;
    }
  }
...
Future<void> getAverageAnimalAge() async {
  // The service would do all the heavy lifting of converting the data to the required response.
  // If you used https://pub.dev/packages/multiple_result you can here, handle that failure.
